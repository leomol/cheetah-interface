classdef SingleElectrode < Cheetah.Object
    methods
        function obj = SingleElectrode(name)
        ...
        function data = getData(obj)
            ...
            [~, ~, data.timeStampArray, data.spikeChannelNumberArray, data.cellNumberArray, data.featureArray, data.dataArray, data.numRecordsReturned, data.numRecordsDropped] = calllib('MatlabNetComClient', 'GetNewSEData', obj.name, timeStampArrayPtr, spikeChannelNumberArrayPtr, cellNumberArrayPtr, featureArrayPtr, dataArrayPtr, numRecordsReturnedPtr, numRecordsDroppedPtr);
