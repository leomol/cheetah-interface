classdef Tetrode < Cheetah.Object
    methods
        function obj = Tetrode(name)
        ...
        function data = getData(obj)
            ...
            [~, ~, data.timeStampArray, data.spikeChannelNumberArray, data.cellNumberArray, data.featureArray, data.dataArray, data.numRecordsReturned, data.numRecordsDropped] = calllib('MatlabNetComClient', 'GetNewTTData', obj.name, timeStampArrayPtr, spikeChannelNumberArrayPtr, cellNumberArrayPtr, featureArrayPtr, dataArrayPtr, numRecordsReturnedPtr, numRecordsDroppedPtr);
            ...
            if data.numRecordsReturned > 0
                ...
                data.dataArray = reshape(data.dataArray, spikeSampleWindowSize, numSubChannels, data.numRecordsReturned);
