% SingleElectrode - Interface with Cheetah Acquisition Entity.
% SingleElectrode methods:
...
classdef SingleElectrode < CheetahWrapper.Stream & CheetahWrapper.WaveformTemplate
    methods
        ...
        function [spikes, dropped] = getData(obj)
            % [spikes, dropped] = CheetahWrapper.SingleElectrode.getData()
            ...
            [~, ~, timestampArray, spikeChannelNumberArray, cellNumberArray, featureArray, dataArray, numRecordsReturned, numRecordsDropped] = calllib('MatlabNetComClient', 'GetNewSEData', obj.name, timestampArrayPtr, spikeChannelNumberArrayPtr, cellNumberArrayPtr, featureArrayPtr, dataArrayPtr, numRecordsReturnedPtr, numRecordsDroppedPtr);
